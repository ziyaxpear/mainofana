...
tabs = ["GİRİŞ", "Steganografi", "Blokzinciri "]
...
def main():
    global c1, c2, d1, d2
    if page == "GİRİŞ":
        st.image(image8, caption="Metamask hesabı ile giriş yapınız")
        st.markdown("Metamask hesabı ile giriş yapınız.Metamask hesabı ile giriş yapmazsanız herhangi bir veri kaydı gerçekleştiremezsiniz.Lütfen aşağıda bulunan metamask butonuna tıklayarak giriş yapınız.")
        st.markdown("<a href= 'http://localhost:63342/stega.py/asd.html?_ijt=q72atsjb4jbhrrjtq4g6h7sil1&_ij_reload=RELOAD_ON_SAVE' target='_parent'>Metamask İle Giriş Yapınız</a>",unsafe_allow_html=True)
    elif page == "Steganografi":
